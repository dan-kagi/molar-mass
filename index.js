const questions = [
    {
        id: "1",
        question: "A massa atômica do cobre é 64 u. Determine a quantidade de cobre presente em 25,6 g deste elemento?",
    ...
    {
        id: "2",
        question: "Calcule a quantidade de etano em 90 g desta substância. Dados: C = 12u e H = 1u",
    ...
    {
        id: "3",
        question: "Qual é a massa em gramas de 0,8 mol de mercúrio? Dado: Hg = 200 u",
    ...
    },
    {
        ...
        options: [
            {isCorrect: true, answer:"1 mol de Al"},
    ...
    {
        id: "6",
        question: "A cafeína é uma substância presente no café. É um estimulante do sistema nervoso central, aumenta o estado de alerta e a capacidade de concentração. No entanto, o consumo excessivo conduz a efeitos colaterais como taquicardia, insônia e ansiedade. Determine a quantidade de moléculas de cafeína, em mol, em uma amostra que apresenta 5,6 g de nitrogênio. Dados: N = 14 u, C = 12 u, H = 1 u e O = 16 u.",
    ...
    {
        id: "7",
        question: "Cloroquina é um remédio utilizado no tratamento da malária. Supondo que em uma amostra de cloroquina há 16,8 g de nitrogênio. Calcule a quantidade de moléculas nesta amostra. Dados: C = 12 u, N = 14 u, Cl = 35,5 u, H = 1 u e O = 16 u.",
    ...
    {
        id: "8",
        question: "Butano é um gás presente no gás cozinha, juntamente com etano e propano. Qual seria a quantidade de átomos de carbono em 29 g de butano? Dados: C = 12 u e H = 1 u.",
        image: "./public/images/fig8.png",
        options: [
            {isCorrect: true, answer:"0,125 mol de C"},
            {isCorrect:false, answer:"0,250 mol de C"},
            {isCorrect:false, answer:"1,250 mol de C"},
            {isCorrect:false, answer:"2,125 mol de C"},
        ],
    },
    {
        id: "9",
        question: "Qual é a quantidade de cloro em 2,22 g de cloreto de sódio. Dados: Massa molar do cloreto de sódio 111 g / mol.",
